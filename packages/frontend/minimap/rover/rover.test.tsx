...
test("<RoverStyle />: snapshot test", () => {
  ...
  expect(roverStyle).toMatchInlineSnapshot(`
    ...
    .c0::before {
      ...
      width: 90%;
      height: 90%;
      background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='100' ry='100' stroke='%230B171EFF' stroke-width='7' stroke-dasharray='16%2c 5%2c 9%2c 20' stroke-dashoffset='84' stroke-linecap='square'/%3e%3c/svg%3e");
      border-radius: 100px;
